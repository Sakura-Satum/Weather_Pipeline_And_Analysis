...
if location in locations:
    ...
    x = [i for i in df_temp['updated_date']]
...
# filtering data
    ...
    for i in range(len(locations)):
        ...
        dict_x['x'+str(i+1)] = [i.strftime('%d/%m/%Y') for i in df_temp['updated_date'][~df_temp['updated_date'].where(df_temp.city.str.strip() == location).isna()]]
